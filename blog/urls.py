...
from . import views
from .views import AllSaveView, PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, SaveView, UserPostListView, like_post,like_comment_view, posts_of_following_profiles,  AllLikeView
