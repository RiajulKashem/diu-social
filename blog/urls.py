...
from . import views
from .views import AllSaveView, PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, SaveView, UserPostListView, like_post,LikeCommentView, posts_of_following_profiles,  AllLikeView
